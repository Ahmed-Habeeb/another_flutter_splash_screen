...
class _FlutterSplashScreenState extends State<FlutterSplashScreen> {
  ...
  didChangeDependencies() async {
    ...
    Future.delayed(widget.duration ?? const Duration(), () {
      ...
      if (widget.nextScreen == null&&widget.nextScreenRoute==null) {
        throw Exception(
            "nextScreen or nextScreenRoute must be provided to navigate to next screen");
      }

      if (widget.nextScreenRoute != null) {
        Navigator.pushReplacementNamed(context, widget.nextScreenRoute!);
        return;
      }
